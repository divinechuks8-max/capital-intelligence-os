"""Mock HTTP transport for SEC EDGAR adapter tests, backed by real fixture
files captured from a live, public Form 4 filing (see atom_feed_sample.xml
...
def build_mock_transport() -> httpx.MockTransport:
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if url.endswith("/ownership.xml"):
            return httpx.Response(200, content=_read("ownership.xml"))
